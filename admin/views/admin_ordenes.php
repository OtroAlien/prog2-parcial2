                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group" aria-label="Acciones">
                                            ...
                                            <a href="index.php?sec=delete_orden&id=<?= htmlspecialchars($orden['orden_id']) ?>" role="button" class="btn btn-danger btn-sm">
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <ul>
                                                    <?php 
                                                    $productos = explode(', ', $orden['detalle_sin_precio']);
                                                    $precios = explode(', ', $orden['precios_unitarios']);
                                                    
                                                    for ($i = 0; $i < count($productos); $i++): 
                                                        $precio = isset($precios[$i]) ? $precios[$i] : 0;
                                                    ?>
                                                        <li>
                                                            <?= htmlspecialchars($productos[$i]) ?>
                                                            <span class="text-muted">- Precio unitario: $<?= htmlspecialchars(number_format((float)$precio, 2, ',', '.')) ?></span>
                                                        </li>
                                                    <?php endfor; ?>
                                                </ul>
                                            </div>
