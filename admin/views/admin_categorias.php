                    ...
                    <form action="../actions/<?= $categoria_seleccionada ? 'update_category.php?id='.$categoria_seleccionada->getId() : 'add_category.php' ?>" method="POST">
                        ...
                        <div class="d-grid gap-2">
                            ...
                            <?php if ($categoria_seleccionada): ?>
                                <a href="index.php?sec=admin_categorias" class="btn btn-secondary">Cancelar Edición</a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Acciones">
                                        <a href="index.php?sec=admin_categorias&categoria_id=<?= htmlspecialchars($categoria->getId()) ?>" role="button" class="btn btn-success btn-sm">
