...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top">
  ...
  <div class="shop">
    <button class="bag" onclick="checkLogin('index.php?sec=carrito')">
    ...
    <button class="user">
      <a class="nav-link" href="<?php echo isset($_SESSION['loggedIn']) ? ($_SESSION['loggedIn']['rol'] == 'usuario' ? 'index.php?sec=panel_usuario' : 'index.php?sec=dashboard') : 'index.php?sec=login'; ?>">
